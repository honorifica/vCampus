...
import vss.server.dao.BookDaoImp;
import vss.server.dao.CourseDaoImp;
...
public class User implements java.io.Serializable {
	...
	{
		String sql="select * from tb_Stb where uID = ?";
		List<String> bookIDset=new SqlHelperImp().sqlRelationQuery(sql, new String[] {id});
		List<Book> bList=new ArrayList<Book>();
		for(String bID:bookIDset)
		{
			bList.add(new BookDaoImp().searchBookByID(bID));
		}
		return bList;
	}
